...
const PricingPage = () => {
  ...
  return (
    <DefaultLayout>
      <Head>
        <title>Bảng Giá Dịch Vụ - Wedding Font Việt Hóa | Miễn Phí & Premium</title>
        <meta
          name="description"
          content="Khám phá bảng giá dịch vụ Wedding Font Việt Hóa với Gói Miễn Phí (Theo Tháng), Premium (Theo Tháng 50.000 VND) và Premium (Theo Năm 500.000 VND). Giới hạn font và hình ảnh tải!"
        />
        <meta
          name="keywords"
          content="bảng giá font chữ, wedding font việt hóa, gói miễn phí, gói premium tháng, gói premium năm, giới hạn font tải, giới hạn hình ảnh tải, giá thiết kế font đám cưới, dịch vụ font"
        />
        ...
        <meta property="og:description" content="Xem chi tiết Gói Miễn Phí, Premium (Theo Tháng) và Premium (Theo Năm) của Wedding Font Việt Hóa với giới hạn font và hình ảnh tải." />
